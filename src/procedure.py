    ...
    def m3_click():
        ...
        stock = tk.Button(m3_frame,
                          ...
                          command = lambda: [mw.window.clear_frame(m3_frame),
                                             ex.recipies.m3_stock_click()]).grid(row = 7, column = 1, padx = 20, pady = 20)
        m3_1L = tk.Button(m3_frame,
                          text = "M3 Solution 2.5 L",
                          font = ("Arial", 20),
                          command = lambda: [mw.window.clear_frame(m3_frame),
                                             ex.recipies.m3_1L_click()]).grid(row = 7, column = 3, padx = 20, pady = 20)
        m3_2L = tk.Button(m3_frame,
                          text = "M3 Solution 5 L",
                          font = ("Arial", 20),
                          command = lambda: [mw.window.clear_frame(m3_frame),
                                             ex.recipies.m3_2L_click()]).grid(row = 8, column =2, padx = 20, pady = 20)
    ...
    def h3a_click():
        ...
        h3a_1L = tk.Button(h3a_frame,
                           ...
                           command = lambda: [mw.window.clear_frame(h3a_frame),
                                              ex.recipies.h3a_1L_click()]).grid(row = 7, column = 1, padx = 20, pady = 20)
        h3a_2L = tk.Button(h3a_frame,
                           text = "H3A 2 L",
                           font = ("Arial", 20),
                           command = lambda: [mw.window.clear_frame(h3a_frame),
                                              ex.recipies.h3a_2L_click()]).grid(row = 7, column = 2, padx = 20, pady = 20)
    ...
    def olsen_click():
        ...
        olsen_1L = tk.Button(olsen_frame,
                             ...
                             command = lambda: [mw.window.clear_frame(olsen_frame),
                                                ex.recipies.olsen_1L_click()]).grid(row = 7, column = 1, padx = 20, pady = 20)
        olsen_2L = tk.Button(olsen_frame,
                             text = "Olsen P 2 L",
                             font = ("Arial", 20),
                             command = lambda: [mw.window.clear_frame(olsen_frame),
                                                ex.recipies.olsen_2L_click()]).grid(row = 7, column = 2, padx = 20, pady = 20)
    ...
    def kcl_click():
        ...
        kcl_1N_1L = tk.Button(kcl_frame,
                              ...
                              command = lambda: [mw.window.clear_frame(kcl_frame),
                                                 ex.recipies.kcl_1N_1L_click()]).grid(row = 7, column = 1, padx = 20, pady = 20)
        kcl_1N_2L = tk.Button(kcl_frame,
                              text = "1N KCl 2 L",
                              font = ("Arial", 20),
                              command = lambda: [mw.window.clear_frame(kcl_frame),
                                                 ex.recipies.kcl_1N_2L_click()]).grid(row = 7, column =2, padx = 20, pady = 20)
        kcl_2N_1L = tk.Button(kcl_frame,
                              text = "2N KCl 1 L",
                              font = ("Arial", 20),
                              command = lambda: [mw.window.clear_frame(kcl_frame),
                                                 ex.recipies.kcl_2N_1L_click()]).grid(row = 8, column =1, padx = 20, pady = 20)
        kcl_2N_2L = tk.Button(kcl_frame,
                              text = "1N KCl 2 L",
                              font = ("Arial", 20),
                              command = lambda: [mw.window.clear_frame(kcl_frame),
                                                 ex.recipies.kcl_2N_2L_click()]).grid(row = 8, column =2, padx = 20, pady = 20)
