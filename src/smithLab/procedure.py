...
class mainFrames(tk.Frame):
    ...
    def piLab_home():
          ...
          smith_lab = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                   text = "Smith Lab",
                                   font = ("Arial", 20),
                                   command = lambda: ctrl.window.smith_lab_click(frame)).grid(row = 2, column = 1,
                                                                                     padx = 20,
                                                                                     pady = 20)
          yost_lab = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "Yost Lab?",
                              font = ("Arial", 20),
                              ).grid(row = 3, column = 1,
                                        padx = 20,
                                        pady = 20)
          Schantz_lab = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "Schantz Lab?",
                              font = ("Arial", 20),
                              ).grid(row = 4, column = 1,
                                        padx = 20,
    ...
    def Smith_lab_home():
          ...
          extraction_protocols = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
          ...
          analytical_instruments = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
          ...
          piLab_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                   text = "piLab Home",
                                   font = ("Arial", 20),
...
class procedure_selection:
    ...
    def instruments_click():
        ...
        cfa = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                        text = "Skalar San ++",
                        font = ("Arial", 25),
    ...
    def m3_click():
        ...
        m3_1L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          text = "M3 Solution 2.5 L",
                          font = ("Arial", 20),
                          command = lambda: ctrl.procedureControl.m3_1_click(frame)).grid(row = 7, column = 3, padx = 20, pady = 20)
        m3_2L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Extractants",
                                 font = ("Arial", 20),
    ...
    def h3a_click():
        ...
        h3a_2L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                           text = "H3A 2 L",
                           font = ("Arial", 20),
    ...
    def olsen_click():
        ...
        olsen_2L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             text = "Olsen P 2 L",
                             font = ("Arial", 20),
    ...
    def kcl_click():
        ...
        kcl_1N_2L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "1N KCl 2 L",
                              font = ("Arial", 20),
                              command = lambda: ctrl.procedureControl.kcl_1N_2L(frame)).grid(row = 7, column =2, padx = 20, pady = 20)
        kcl_2N_1L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "2N KCl 1 L",
                              font = ("Arial", 20),
                              command = lambda: ctrl.procedureControl.kcl_2N_1L(frame)).grid(row = 8, column =1, padx = 20, pady = 20)
        kcl_2N_2L = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "1N KCl 2 L",
                              font = ("Arial", 20),
    ...
    def extraction_protocol():
        ...
        mehlich3 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             ...
                             command = lambda: ctrl.procedureControl.m3_proto_click(frame)).grid(row = 7, column = 1,
                                                                                              padx = 20,
                                                                                              pady = 20)
        potassiumChloride = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                            text = "KCl Extraction",
                            font = ("Arial", 20),
                            command = lambda: ctrl.procedureControl.kcl_proto_click(frame)).grid(row = 7, column = 2,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        olsenP = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
        ...
        h3a = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                        ...
                        command = lambda: ctrl.procedureControl.h3a_proto_click(frame)).grid(row = 8, column = 1,
                                                                                  padx = 20,
                                                                                  pady = 20)
        hcl = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                        text = "HCl Extraction",
                        font = ("Arial", 20),
