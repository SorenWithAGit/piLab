...
class mainFrames(tk.Frame):
    ...
    def piLab_home():
          ...
          welcome_label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                              text = welcome,
                              height = 10,
                              width = 52,
                              font = ("Arial", 20)).grid(row = 1, columnspan = 3)
          smith_lab = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                   text = "Smith Lab",
                                   font = ("Arial", 20),
                                   command = lambda: ctrl.window.smith_lab_click(frame)).grid(row = 2, column = 1,
                                                                                     padx = 20,
                                                                                     pady = 20)
          yost_lab = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                              text = "Yost Lab?",
                              font = ("Arial", 20),
                              ).grid(row = 3, column = 1,
                                        padx = 20,
                                        pady = 20)
          Schantz_lab = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                              text = "Schantz Lab?",
                              font = ("Arial", 20),
                              ).grid(row = 4, column = 1,
                                        padx = 20,
    ...
    def Smith_lab_home():
          ...
          for i in range(1,6):
                    label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                                   text = "").grid(row = i)
          extracts = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
          ...
          extraction_protocols = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
          ...
          analytical_instruments = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
          ...
          piLab_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                   text = "piLab Home",
                                   font = ("Arial", 20),
...
class procedure_selection:
    ...
    def instruments_click():
        ...
        for i in range(1,6):
            label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                             text = "").grid(row = i)
        icp = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                        text = "ICP-OES",
                        font = ("Arial", 25),
                        command = lambda: ctrl.icpWindowControl.icp_home(frame)).grid(row = 7, column = 0, padx = 20, pady = 20)
        cfa = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                        text = "Skalar San ++",
                        font = ("Arial", 25),
    ...
    def m3_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 text = "Extractants",
                                 font = ("Arial", 20),
    ...
    def h3a_click():
        ...
        for i in range(1,6):
            label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                             text = "").grid(row = i)
        h3a_1L = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                           text = "H3A 1 L",
                           font = ("Arial", 20),
                           command = lambda: ctrl.procedureControl.h3a_1_click(frame)).grid(row = 7, column = 1, padx = 20, pady = 20)
        h3a_2L = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                           text = "H3A 2 L",
                           font = ("Arial", 20),
    ...
    def olsen_click():
        ...
        for i in range(1,6):
            label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                             text = "").grid(row = i)
        olsen_1L = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             text = "Olsen P 1 L",
                             font = ("Arial", 20),
                             command = lambda: ctrl.procedureControl.olsen_1_click(frame)).grid(row = 7, column = 1, padx = 20, pady = 20)
        olsen_2L = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             text = "Olsen P 2 L",
                             font = ("Arial", 20),
    ...
    def extraction_protocol():
        ...
        for i in range(1,6):
            label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                             text = "").grid(row = i)
        mehlich3 = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             text = "M3 Extraction",
                             font = ("Arial", 20),
                             command = lambda: ctrl.procedureControl.m3_proto_click(frame)).grid(row = 7, column = 1,
                                                                                              padx = 20,
                                                                                              pady = 20)
        potassiumChloride = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                            text = "KCl Extraction",
                            font = ("Arial", 20),
                            command = lambda: ctrl.procedureControl.kcl_proto_click(frame)).grid(row = 7, column = 2,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        olsenP = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
        ...
        h3a = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                        ...
                        command = lambda: ctrl.procedureControl.h3a_proto_click(frame)).grid(row = 8, column = 1,
                                                                                  padx = 20,
                                                                                  pady = 20)
        hcl = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                        text = "HCl Extraction",
                        font = ("Arial", 20),
