...
def tocHome():
    ...
    standards = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          ...
                          command = lambda: ctrl.toc.stds(frame)).grid(row = 4, column = 0,
                                                     padx = 20,
                                                     pady = 20)
    steps = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def standardFrame():
        ...
        std3 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                         ...
                         command = lambda: ctrl.toc.std3(frame)).grid(row = 4, column = 2,
                                                     padx = 20,
                                                     pady = 20)
        phos = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
        ...
        instrumentation_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                        ...
                                        command = lambda: ctrl.window.analytical_instrumentation_click(frame)).grid(row = 9, 
                                                                                                                column = 1,
                                                                                                                columnspan = 2)
        toc_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             text = "TOC Home",
                             font = ("Arial", 20),
    ...
    def std1_click():
        ...
        instructions_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                      ...
                                      command = lambda: ctrl.window.analytical_instrumentation_click(frame)).grid(row = 9, column = 1,
                                                                                                    padx = 20,
                                                                                                    pady = 20)
        TOC_home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                    font = ("Arial", 20),
                                    text = "TOC Home",
                                    command = lambda: ctrl.toc.toc_home(frame)).grid(row = 9, column = 2,
                                                                                    padx = 20,
                                                                                    pady = 20)
        icSTD_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "IC Standard",
                                font = ("Arial", 20),
                                command = lambda: ctrl.toc.std2(frame)).grid(row = 10, column = 1,
                                                                                padx = 20,
                                                                                pady = 20)
        tnSTD_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "TN Standard",
                                font = ("Arial", 20),
    ...
    def std2_click():
        ...
        TOC_home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                    ...
                                    command = lambda: ctrl.toc.toc_home(frame)).grid(row = 9, column = 2,
                                                                                    padx = 20,
                                                                                    pady = 20)
        tcSTD_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "TC Standard",
                                font = ("Arial", 20),
