    ...
    def m3_stock_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        m3_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def h3a_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        h3a_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def olsen_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        olsen_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def kcl_1N_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        kcl_recipes_Button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
