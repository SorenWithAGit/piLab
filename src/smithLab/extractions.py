...
class recipes:
    ...
    def m3_stock_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 text = "Extractants",
                                 font = ("Arial", 20),
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        m3_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                      text = "Mehlich 3 Recipes",
                                      font = ("Arial", 20),
                                      command = lambda: ctrl.procedureControl.m3_click(frame)).grid(row = 5, column = 2,
                                                                                                  padx = 20, 
                                                                                                  pady = 20)
    ...
    def h3a_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        h3a_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                      text = "Haney 3 Acids Recipes",
                                      font = ("Arial", 20),
                                      command = lambda: ctrl.procedureControl.h3a_click(frame)).grid(row = 5, column = 2,
                                                                                                  padx = 20, 
                                                                                                  pady = 20)
    ...
    def olsen_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        olsen_recipes_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                      text = "Olsen P Recipes",
                                      font = ("Arial", 20),
                                      command = lambda: ctrl.procedureControl.olsen_click(frame)).grid(row = 5, column = 2,
                                                                                                  padx = 20, 
                                                                                                  pady = 20)
    ...
    def kcl_1N_1L_click():
        ...
        extract_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: ctrl.procedureControl.extract_home_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
        kcl_recipes_Button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                      text = "Potassium Chloride Recipes",
                                      font = ("Arial", 20),
                                      command = lambda: ctrl.procedureControl.kcl_click(frame)).grid(row = 5, column = 2,
                                                                                                  padx = 20, 
                                                                                                  pady = 20)
...
class extract_protocol:
    ...
    def mehlich3_pro_click():
        ...
        extraction_protocols= tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 ...
                                 font = ("Arial", 20),
                                 command = lambda: ctrl.procedureControl.extraction_proto_click(frame)).grid(row = 5, column = 1,
                                                                                                   padx = 20,
                                                                                                   pady = 20)
