...
class icp_cookbook:
    def icp_home_frame():
        ...
        instrument_recipies = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def icp_element_frame():
        ...
        main_label = tk.label = tk.Label(frame, bg = "#133d22", fg = "#c8c3e6",
                              ...
                              font = ("Arial", 25)).grid(row = 0, columnspan = 4,
                                                         padx = 20,
                                                         pady = 20)
        Al_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                    text = "Aluminium",
                                    font = ("Arial", 20),
                                    command = lambda: ctrl.icpWindowControl.al_click(frame)).grid(row = 1, column = 0,
                                                            padx = 50, pady = 50)
        Ca_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Calcium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.ca_click(frame)).grid(row = 1,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Cu_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Copper",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.cu_click(frame)).grid(row = 1,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        Fe_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Iron",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.fe_click(frame)).grid(row = 1,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady =50)
        K_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Potassium",
                                font = ("Arial", 20),
                                command = lambda:ctrl.icpWindowControl.k_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Mg_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Magnesium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.mg_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Mn_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Manganese",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.mn_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Na_Button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Sodium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.na_click(frame)).grid(row = 3,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        P_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Phosphorus",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.p_click(frame)).grid(row = 3,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        S_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Sulfur",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.s_click(frame)).grid(row = 3,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        Zn_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Zinc",
                                font = ("Arial", 20),
        ...
        icp_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             text = "ICP Home",
                             font = ("Arial", 20),
        ...
        ppm_1000 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             ...
                             command = lambda: [ctrl.window.clear_frame(frame),
                                                icp_control.desired_conc(1000, element)]).grid(row = 1,
                                                                              column = 0,
                                                                              pady = 20)
        ppm_10000 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                             font = ("Arial", 20),
                             ...
                             command = lambda: [ctrl.window.clear_frame(frame),
                                                icp_control.desired_conc(10000, element),]).grid(row = 2,
                                                                              column = 0,
                                                                              pady = 20)
        home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                font = ("Arial", 20),
                                text = "ICP Home",
        ...
        clear_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: [concentrations.clear(),
                                                    text.delete("1.0", "end")]).grid(row = 5,
                                                                             ...
                                                                             padx = 10,
                                                                             pady = 10)
        conc_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def steps():
        ...
        step1_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                ...
                                command = lambda: ctrl.icpWindowControl.icp_step1(frame)).grid(row = 4, column = 0,
                                                                                padx = 20,
                                                                                pady = 20)
        step2_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 2",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step2(frame)).grid(row = 4, column = 1,
                                                                                padx = 20,
                                                                                pady = 20)
        step3_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 3",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step3(frame)).grid(row = 4, column = 2,
                                                                                padx = 20,
                                                                                pady = 20)
        step4_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 4",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step4(frame)).grid(row = 5, column = 0,
                                                                                padx = 20,
                                                                                pady = 20)
        step5_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 5",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step5(frame)).grid(row = 5, column = 1,
                                                                                padx = 20,
                                                                                pady = 20)
        step6_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 6",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step6(frame)).grid(row = 5, column = 2,
                                                                                padx = 20,
                                                                                pady = 20)
        step7_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 7",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step7(frame)).grid(row = 6, column = 0,
                                                                                padx = 20,
                                                                                pady = 20)
        step8_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 8",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.icp_step8(frame)).grid(row = 6, column = 1,
                                                                                padx = 20,
                                                                                pady = 20)
        step9_click = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Step 9",
                                font = ("Arial", 20),
    ...
    def step1():
        ...
        smith_home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                ...
                                command = lambda: ctrl.window.smith_lab_click(frame)).grid(row = 9, column = 0,
                                                                      padx = 20,
                                                                      pady = 20)
        instructions_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                      font = ("Arial", 20),
                                      text = "Instrumentation Home",
                                      command = lambda: ctrl.window.analytical_instrumentation_click(frame)).grid(row = 9, column = 1,
                                                                                                    padx = 20,
                                                                                                    pady = 20)
        step_home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                     font = ("Arial", 20),
                                     text = "ICP Step Home",
                                     command = lambda: ctrl.icpWindowControl.icp_step_home(frame)).grid(row = 9, column = 2,
                                                                                      padx = 20,
                                                                                      pady = 20)
        next_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                font = ("Arial", 20),
                                text = "Step 2",
    ...
    def step2():
        ...
        step_home_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                     ...
                                     command = lambda: ctrl.icpWindowControl.icp_step_home(frame)).grid(row = 9, column = 2,
                                                                                      padx = 20,
                                                                                      pady = 20)
        previous_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                font = ("Arial", 20),
                                text = "Step 1",
