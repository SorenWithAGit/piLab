...
class icp_cookbook:
    def icp_home_frame():
        ...
        std4_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
    ...
    def icp_element_frame():
        ...
        main_label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                              ...
                              font = ("Arial", 25)).grid(row = 0, columnspan = 4,
                                                         padx = 20,
                                                         pady = 20)
        Al_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                    text = "Aluminium",
                                    font = ("Arial", 20),
                                    command = lambda: ctrl.icpWindowControl.al_click(frame)).grid(row = 1, column = 0,
                                                            padx = 50, pady = 50)
        Ca_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Calcium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.ca_click(frame)).grid(row = 1,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Cu_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Copper",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.cu_click(frame)).grid(row = 1,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        Fe_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Iron",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.fe_click(frame)).grid(row = 1,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady =50)
        K_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Potassium",
                                font = ("Arial", 20),
                                command = lambda:ctrl.icpWindowControl.k_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Mg_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Magnesium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.mg_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Mn_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Manganese",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.mn_click(frame)).grid(row = 2,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        Na_Button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Sodium",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.na_click(frame)).grid(row = 3,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        P_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Phosphorus",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.p_click(frame)).grid(row = 3,
                                                                                        ...
                                                                                        padx = 50,
                                                                                        pady = 50)
        S_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Sulfur",
                                font = ("Arial", 20),
                                command = lambda: ctrl.icpWindowControl.s_click(frame)).grid(row = 3,
                                                                                    ...
                                                                                    padx = 50,
                                                                                    pady = 50)
        Zn_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                text = "Zinc",
                                font = ("Arial", 20),
        ...
        icp_home = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             text = "ICP Home",
                             font = ("Arial", 20),
...
class icp_control:
    ...
    def stock_solutions(element):
        ...
        frame = tk.Frame(bg = "#211e1e")
        frame.pack()
        choose_label = tk.Label(frame, bg = "#211e1e", fg = "#ede1e1",
                                text = "Choose " + element + " Stock Standard",
                                font = ("Arial", 25)).grid(row = 0, column =0, columnspan = 5)
        ppm_1000 = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             font = ("Arial", 20),
                             ...
                             command = lambda: [ctrl.window.clear_frame(frame),
                                                icp_control.desired_conc(1000, element)]).grid(row = 1,
                                                                              column = 0,
                                                                              pady = 20)
        ppm_10000 = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                             font = ("Arial", 20),
    ...
    def desired_conc(stock_conc, element):
        ...
        clear_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
                                 ...
                                 command = lambda: [concentrations.clear(),
                                                    text.delete("1.0", "end")]).grid(row = 5,
                                                                             ...
                                                                             padx = 10,
                                                                             pady = 10)
        conc_button = tk.Button(frame, bg = "#453f3f", fg = "#ede1e1", bd = 5, relief = "raised",
