...
class skalar_cookbook:
    ...
    def nitrate_frame():
        ...
        color_reag = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                               text = "Color Reagent",
                               font = ("Arial", 20),
    ...
    def ammonium_frame():
        ...
        sali_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
        ...
        nitro_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Nitroprusside Solution",
                                 font = ("Arial", 20),
                                 command = lambda: ctrl.skalarWindowControl.nitro_click(frame)).grid(row = 7, column = 1, padx = 20, pady = 20)
        dichlo_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
    ...
    def buffer_volume_frame(reagent):
        ...
        vol_2 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          text = "1,000 mL",
                          font = ("Arial", 20),
                          command = lambda: ctrl.skalarWindowControl.buff_vol2_click(frame, reagent)).grid( row = 6, column = 2, padx = 20, pady = 40)
        vol_3 = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          text = "2,000 mL",
                          font = ("Arial", 20),
