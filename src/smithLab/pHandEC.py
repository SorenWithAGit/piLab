...
def phec_frame():
    ...
    ec_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          ...
                          command = lambda: ctrl.pHEC.ec_click(frame)).grid(row = 4, column = 1,
                                                             padx = 20,
                                                             pady = 20)
    ph_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                          text = "pH Meter",
                          font = ("Arial", 20),
    ...
    def ec_steps():
        ...
        cal_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                            ...
                            command = lambda: ctrl.pHEC.ec_cal_click(frame)).grid(row = 4, column = 0,
                                    padx = 20,
                                    pady = 20)
        step1_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Measurement Mode",
                                 font = ("Arial", 20),
                                 command = lambda: ctrl.pHEC.ec_mode_click(frame)).grid(row = 4, column = 1,
                                        padx = 20,
                                        pady = 20)
        step2_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Measurement",
                                 font = ("Arial", 20),
        ...
        instrumentation_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                         ...
                                         command = lambda: ctrl.window.analytical_instrumentation_click(frame)).grid(row = 8, 
                                                                                                                  column = 1)
        phec_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "pH and EC Home",
                              font = ("Arial", 20),
    ...
    def cal_click():
        ...
        instrumentation_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                         ...
                                         command = lambda: ctrl.window.analytical_instrumentation_click(frame)).grid(row = 9, 
                                                                                                                  column = 1)
        steps_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              text = "EC Steps",
                              font = ("Arial", 20),
    ...
    def ph_steps():
        ...
        cal_check = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                            ...
                            command = lambda: ctrl.pHEC.ph_cal_check(frame)).grid(row = 4, column = 0,
                                    padx = 20,
                                    pady = 20)
        cal = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Calibration",
                                 font = ("Arial", 20),
                                 command = lambda: ctrl.pHEC.ph_cal(frame)).grid(row = 4, column = 1,
                                        padx = 20,
                                        pady = 20)
        meas = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                 text = "Measurement",
                                 font = ("Arial", 20),
    ...
    def ph_cal_check():
        ...
        cal_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                            ...
                            command = lambda: ctrl.pHEC.ph_cal(frame)).grid(row = 10, column = 1,
                                                                                padx = 20,
                                                                                pady = 20)
        measure_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                   text = "Measurement",
                                   font = ("Arial", 20),
    ...
    def ph_cal():
        ...
        steps_home = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                              ...
                              command = lambda: ctrl.pHEC.ph_click(frame)).grid(row = 9, column = 2,
                                                                         padx = 20,
                                                                         pady = 20)
        cal_check_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                    text = "Calibration Check",
                                    font = ("Arial", 20),
                                    command = lambda: ctrl.pHEC.ph_cal_check(frame)).grid(row = 10, column = 0,
                                                                                          padx = 20,
                                                                                          pady = 20)
        meas_button = tk.Button(frame, bg = "#453f3f", fg = "#c8c3e6", bd = 5, relief = "raised",
                                text = "Measurement",
                                font = ("Arial", 20),
                                command = lambda: ctrl.pHEC.ph_measure_click(frame)).grid(row = 10, column = 2,
                                                                                          padx = 20,
